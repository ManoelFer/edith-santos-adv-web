...
- **Identidade visual:** fundo escuro (`page` #08090A) com dourado da marca (`primary` #C69C5D, o tom da parte mais escura do dourado da logo, clareado). Fontes Public Sans (texto) e Instrument Serif (títulos). Tokens em `src/styles/global.css`.
